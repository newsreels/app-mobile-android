...
class Constants {
    ...
    public static final String POST_DEVICE_CODE = "device_code";

    public static final String HEADER_AUTHORIZATION = "Authorization";

    public static final String POST_SUBJECT_TOKEN = "subject_token";
    public static final String POST_SUBJECT_TOKEN_TYPE = "subject_token_type";
}
