...
public class RangeSeekBarViewJAva extends View {
    private static final String TAG = RangeSeekBarViewJAva.class.getSimpleName();
...
//    private Bitmap thumbPressedImage;
    ...
    public RangeSeekBarViewJAva(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public RangeSeekBarViewJAva(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public RangeSeekBarViewJAva(Context context, long absoluteMinValuePrim, long absoluteMaxValuePrim, int thumbsCount) {
        super(context);
...
//        paint);
    ...
    public interface OnRangeSeekBarChangeListener {
        void onRangeSeekBarValuesChanged(RangeSeekBarViewJAva bar, long minValue, long maxValue, int action, boolean isMin, Thumb pressedThumb);
    }
