package com.newsreels.app.mediapicker.model;
...
import com.newsreels.app.mediapicker.entity.MediaData;
import com.newsreels.app.mediapicker.listener.OnQueryDataResultListener;
...
import com.newsreels.app.mediapicker.utils.ValueOf;
                ...
                try {
                    if (data != null) {
                        ...
                        if (count > 0) {
                            ...
                            String bucketDisplayName =  mContext.getString(R.string.picture_camera_roll);
