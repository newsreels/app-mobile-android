package com.newsreels.app.mediapicker.utils;
...
import com.newsreels.app.mediapicker.config.UCropOptions;
import com.newsreels.app.mediapicker.engine.CacheResourcesEngine;
import com.newsreels.app.mediapicker.engine.ImageEngine;
import com.newsreels.app.mediapicker.entity.LocalMedia;
import com.newsreels.app.mediapicker.gallery.InstagramSelectionConfig;
import com.newsreels.app.mediapicker.gallery.PictureSelectorInstagramStyleActivity;
import com.newsreels.app.mediapicker.listener.OnCustomCameraInterfaceListener;
import com.newsreels.app.mediapicker.listener.OnVideoSelectedPlayCallback;
import com.newsreels.app.mediapicker.style.PictureCropParameterStyle;
import com.newsreels.app.mediapicker.style.PictureParameterStyle;
import com.newsreels.app.mediapicker.style.PictureWindowAnimationStyle;
...
public class PictureSelectionModel {
    ...
    public PictureSelectionModel isReel(boolean isReel) {
        selectionConfig.isReel = isReel;
        return this;
    }
    ...
    /**
     * Extra used with   to indicate that
     *
    ...
    public void forResult(int requestCode) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            Intent intent;
            if (fragment != null) {
                intent = new Intent(fragment.getContext(), PictureSelectorInstagramStyleActivity.class);
                fragment.startActivityForResult(intent, requestCode);
                PictureWindowAnimationStyle windowAnimationStyle = selectionConfig.windowAnimationStyle;
                if (fragment.getActivity() != null)
                    fragment.getActivity().overridePendingTransition(windowAnimationStyle != null &&
                ...
                intent = new Intent(activity, PictureSelectorInstagramStyleActivity.class);
