...
import static com.newsreels.app.activities.AddPostPlaceActivity.LOCATION_RESULT_KEY;
import static com.newsreels.app.activities.LanguageActivity.LANGUAGE_RESULT_KEY;
import static com.newsreels.app.data.POST_TYPE.REELS;
import static com.newsreels.app.data.POST_TYPE.VIDEO_ARTICLE;
...
import com.newsreels.app.activities.Channel.PostToChannelActivity;
import com.newsreels.app.adapters.AddBulletsAdapter;
import com.newsreels.app.background.UploadInfo;
import com.newsreels.app.background.VideoInfo;
import com.newsreels.app.background.VideoProcessorService;
import com.newsreels.app.background.VideoStatus;
import com.newsreels.app.data.MODE;
import com.newsreels.app.data.POST_TYPE;
import com.newsreels.app.data.PostArticleParams;
import com.newsreels.app.data.PrefConfig;
import com.newsreels.app.data.models.location.Location;
import com.newsreels.app.data.models.postarticle.CurrentLocations;
import com.newsreels.app.data.models.postarticle.CurrentTags;
import com.newsreels.app.data.models.postarticle.TagItem;
import com.newsreels.app.data.models.sources.Source;
import com.newsreels.app.fragments.LoadingProgressDialog;
import com.newsreels.app.fragments.SchedulePickerDialog;
import com.newsreels.app.interfaces.AdapterItemCallback;
import com.newsreels.app.interfaces.PostArticleCallback;
...
import com.newsreels.app.model.SelectedChannel;
...
import com.newsreels.app.model.language.LanguagesItem;
import com.newsreels.app.model.searchhistory.History;
import com.newsreels.app.presenter.PostArticlePresenter;
import com.newsreels.app.utills.BlurTransformation;
...
//                                }
                                if (!TextUtils.isEmpty(videoInfo.getPath())) {
                                    Glide.with(this)
                                            ...
                                            .apply(RequestOptions.bitmapTransform(new com.newsreels.app.utills.BlurTransformation(50, 10)))
