...
import com.newsreels.app.adapters.MainActivityAdapter;
    ...
    public void onBindViewHolder(@NonNull @NotNull RecyclerView.ViewHolder holder1, int position) {
        if (holder1 instanceof TitleViewHolder || holder1 instanceof CircleTopicsViewHolder ||
            ...
            if (holder1 instanceof TitleViewHolder) {
                ...
                RelevantItem relevantItem = relevantItemArrayList.get(position);
                ArrayList<com.newsreels.app.data.models.relevant.Location> locationArrayList = relevantItem.getObject() != null ? (ArrayList<com.newsreels.app.data.models.relevant.Location>) relevantItem.getObject() : new ArrayList<>();
...
//                ArrayList<com.newsreels.app.data.models.sources.Source> finalSourceArrayList = sourceArrayList;
