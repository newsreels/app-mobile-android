package com.newsreels.app.adapters.following;
...
import com.newsreels.app.activities.HashTagDetailsActivity;
...
public class CirclePlacesAdapter extends RecyclerView.Adapter<CirclePlacesAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Location> mFollowedLocations;
    private FollowUnfollowPresenter presenter;

    public CirclePlacesAdapter(Context context, ArrayList<Location> mFollowedLocations) {
