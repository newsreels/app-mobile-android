package com.newsreels.app.adapters.discover_new
...
class CryptoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun onBind(
        ...
        itemView.findViewById<TextView>(R.id.tv_more).setOnClickListener {
            if (cryptoForexApiResponse != null) {
                discoverChildInterface.onCryptoSeeAllClick(cryptoForexApiResponse)
            }
        }
//        if(cryptoForexApiResponse?.tickers?.size!! >= 5){
//            itemView.findViewById<TextView>(R.id.tv_more).setOnClickListener {
//                discoverChildInterface.onCryptoSeeAllClick(cryptoForexApiResponse.tickers)
//            }
//        }else{
//            itemView.findViewById<TextView>(R.id.tv_more).visibility = View.GONE
//        }
        if (cryptoForexApiResponse != null) {
            ...
            val cryptoAdapter = CryptoPricesAdapter()
