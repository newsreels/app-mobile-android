 ...
 */
public class EditionsAdapter extends RecyclerView.Adapter<EditionsAdapter.ViewHolder> {
    private ArrayList<EditionsItem> mItems = new ArrayList<>();
    private Activity mContext;
    private EditionOnclickCallback mCallback;
    private PrefConfig prefConfig;

    public EditionsAdapter(ArrayList<EditionsItem> mItems, Activity context) {
        this.mItems = mItems;
    ...
    public void setAdapter(ArrayList<EditionsItem> arrayList, EditionsItem item, ViewHolder holder) {
        if (holder != null && holder instanceof ViewHolder) {
            ...
            adapter.setCallback(new SubEditionsAdapter.EditionOnclickCallback() {
                @Override
