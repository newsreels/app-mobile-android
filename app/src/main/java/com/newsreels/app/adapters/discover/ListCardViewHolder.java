...
public class ListCardViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(int position, DiscoverItem item) {
        ...
        if (item != null && item.getData() != null) {
            ...
            ArrayList<com.newsreels.app.model.articles.Article> articles = item.getData().getArticles();
            if (articles != null && articles.size() > 0) {
                for (int i = 0; i < articles.size(); i++) {
                    com.newsreels.app.model.articles.Article articlesItem = articles.get(i);
