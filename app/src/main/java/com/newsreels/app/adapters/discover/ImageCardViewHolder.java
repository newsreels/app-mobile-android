...
import com.newsreels.app.activities.CustomDiscoverListActivity;
...
public class ImageCardViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImageCardViewHolder(@NonNull View itemView, Activity context, Callback callback) {
        super(itemView);
...
//                image_list_3.setAdapter(new ImageScrollAdapter(iconArrayList3, callback));
    ...
    private void resume() {
        ...
        myTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                if (image_list != null && image_list_2 != null) {
