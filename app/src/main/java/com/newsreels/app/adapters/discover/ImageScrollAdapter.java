...
import com.newsreels.app.model.NewDiscoverPage.Icon;

import org.jetbrains.annotations.NotNull;

import java.util.ArrayList;

public class ImageScrollAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ImageScrollAdapter(ArrayList<Icon> iconArrayList, Callback callback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_SPACER){
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_scroll_adapter_item_2, parent, false);
        }else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_scroll_adapter_item, parent, false);
        }
