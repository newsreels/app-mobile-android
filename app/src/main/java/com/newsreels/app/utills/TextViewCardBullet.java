 ...
 * @since Apr 4, 2011
 */
public class TextViewCardBullet extends androidx.appcompat.widget.AppCompatTextView {

    // Minimum text size for this text view
    public static final float MIN_TEXT_SIZE = 28;

    // Maximum text size for this text view
    public static final float MAX_TEXT_SIZE = 50;
    ...
    public TextViewCardBullet(Context context) {
        this(context, null);
    }

    // Default constructor when inflating from XML file
    public TextViewCardBullet(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    // Default constructor override
    public TextViewCardBullet(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void resizeText(int width, int height) {
        ...
        if (Utils.getResolution((Activity) getContext()) > 2) {
            //big device
            mMaxTextSize = 50;
        } else {
            //small device
