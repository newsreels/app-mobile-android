...
import com.newsreels.app.adapters.NewFeed.NewTopicsViewHolder;
import com.newsreels.app.adapters.NewFeed.SuggestedArticlesHolder;
import com.newsreels.app.adapters.NewFeed.SuggestedChannelHolder;
import com.newsreels.app.adapters.NewFeed.TopicsViewHolder;
...
import com.newsreels.app.adapters.feed.AdViewHolder;
import com.newsreels.app.adapters.feed.FacebookAdViewHolder;
...
import com.newsreels.app.adapters.foryou.EdgeToEdgeImage;
import com.newsreels.app.adapters.foryou.EdgeToEdgeVideo;
import com.newsreels.app.adapters.foryou.EdgeToEdgeYoutube;
...
public class HomeAdapterPlaces extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements AdapterCallback, CacheManager {
    ...
    public HomeAdapterPlaces(boolean isDark, CommentClick mCommentClick, boolean isPostArticle, AppCompatActivity context, ArrayList<Article> items, String type,
...
//                            youtubeViewHolder.statusView.requestLayout();
            ...
            case TYPE_SUGGESTED_REELS:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.community_suggested_item_places, parent, false);
                return new SuggestedReelsHolder(view, context, false,true);
...
//            }
    ...
    public class TitleViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Article article) {
            if (article != null) {
                llContainer.setBackgroundColor(context.getResources().getColor(R.color.discover_bg));
    ...
    class LineHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Article article) {
            liner.setBackgroundColor(context.getResources().getColor(R.color.discover_bg));
        }
    }
}
