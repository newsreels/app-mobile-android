...
import com.newsreels.app.adapters.UploadHolderAdapter;
import com.newsreels.app.adapters.feed.FeedAdapter;
...
public class ProfileArticleFragment extends Fragment implements NewsCallback {
...
//            setTitle(name, name.equalsIgnoreCase(getString(R.string.profile)) || type == TYPE.TOPIC || type == TYPE.SOURCE || type == TYPE.SOURCE_PUSH || type == TYPE.ARCHIVE || type == TYPE.LOCATION);
    ...
    public static ProfileArticleFragment newInstance(String sourceId) {
        ProfileArticleFragment profileArticleFragment = new ProfileArticleFragment();
        Bundle bundle = new Bundle();
        bundle.putString(BUNDLE_SOURCE, sourceId);
        profileArticleFragment.setArguments(bundle);
        return profileArticleFragment;
    }
    ...
    public void updateArticles() {
        ...
        presenter.loadMyArticles("", sourceId, nextPage);
    }
...
//        nestedScrollView = view.findViewById(R.id.nestedScrollView);
    ...
    private void setAdapter() {
        mCardAdapter = new FeedAdapter(new CommentClick() {
        ...
        }, false, (AppCompatActivity) getActivity(), mContentArrayList, "MY_ARTICLES", false, new DetailsActivityInterface() {
            @Override
            ...
            @Override
            public void pause() {
                ProfileArticleFragment.this.pause();
            }
