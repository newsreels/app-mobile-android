...
public class FeedPlacesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements AdapterCallback, CacheManager {
...
//    public TempCategoryFragment tempCategoryFragment;
    ...
    public FeedPlacesAdapter(CommentClick mCommentClick, boolean isPostArticle, AppCompatActivity context, List<Article> items, String type, boolean isGotoFollowShow, DetailsActivityInterface detailsActivityInterface,
