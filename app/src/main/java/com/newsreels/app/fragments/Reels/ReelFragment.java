...
import static com.newsreels.app.utills.PaginationListener.PAGE_START;
...
import com.newsreels.app.fragments.test.NetworkSpeedUtils;
import com.newsreels.app.fragments.test.ReelFraInterface;
import com.newsreels.app.fragments.test.ReelsNewPresenter;
import com.newsreels.app.fragments.test.VideoAdapter;
import com.newsreels.app.interfaces.BottomSheetInterface;
...
import com.newsreels.app.presenter.HomePresenter;
...
import com.newsreels.app.utills.M3UParser;
...
//                            userFollowBtn.setEnabled(true);
    ...
    public void forYouBottomSheet() {
        ...
        forYouReelSheet = ForYouReelSheet.getInstance("reels", Constants.CAT_TYPE_REELS, context, homeModel, view -> {
