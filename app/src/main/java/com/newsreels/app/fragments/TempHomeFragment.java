...
import static com.newsreels.app.utills.Constants.HomeSelectedFragment;
import static com.newsreels.app.utills.Constants.firstTime;
import static com.newsreels.app.utills.Constants.isHeader;
...
import com.newsreels.app.adapters.TempCategoryAdapter;
...
import com.newsreels.app.utills.CustomViewPager;
...
//            categoriesAdapter.setData(categoryFragmentModels);
            categoriesAdapter.notifyDataSetChanged();
...
//                        categoryTabs.addTab(categoryTabs.newTab().setText(model.getName()));
    ...
    public void forYouBottomSheet(String id, HomeModel model) {
        ...
        forYouReelSheet = ForYouReelSheet.getInstance("articles", Constants.CAT_TYPE_ARTICLES, id, model, view -> {
